...
start "Firefox Developer Edition" "https://www.mozilla.org/en-US/firefox/developer/all/?q=French,%20Fran%C3%A7ais"
...
start "Windows 10 Start Fresh" "https://www.microsoft.com/fr-ca/software-download/windows10startfresh"
start "PuTTY" "http://www.chiark.greenend.org.uk/~sgtatham/putty/download.html"
start "Python" "https://www.python.org/downloads/windows/"
