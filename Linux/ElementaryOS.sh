...
# Install
sudo apt install -y --auto-remove adb aria2 baobab default-jdk font-manager git git-lfs krita neofetch p7zip-full snapd software-properties-common steam youtube-dl
